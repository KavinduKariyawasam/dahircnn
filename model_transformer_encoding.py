...
bitmodule = SourceFileLoader('bitmodule', '/home/deependra/kuyesera/dahircnn/bit_resnet.py').load_module()
...
class ResNet_UNet(torch.nn.Module):
    ...
    def forward_single(self, x):
        ...
        # print(f"forward single pass completed !!")
...
class BASE_Transformer_UNet(ResNet_UNet):
    ...
    def __init__(self, input_nc, output_nc, with_pos=None, resnet_stages_num=5,
        ...
        dim_5, dim_4, dim_3, dim_2 = 32, 32, 32, 32     # TODO
    ...
    def forward(self, x):
        ...
        print(f"1 difference block shape: {out_3.shape}")
        out_3 = out_3 + out_4
...
#################### Custom ###########################
class Custom_Transformer_UNet(ResNet_UNet):
    """
    Resnet of 8 downsampling + BIT + bitemporal feature Differencing + a small CNN
    """
    def __init__(self, input_nc, output_nc, with_pos=None, resnet_stages_num=5,
                 ...
                 decoder_softmax=True, with_decoder_pos=None,
                 with_decoder=True):
        super(Custom_Transformer_UNet, self).__init__(input_nc, output_nc,backbone=backbone,
                                             resnet_stages_num=resnet_stages_num,
                                               if_upsample_2x=if_upsample_2x,
                                               )

        print("using UNet Encoder !!!!") 
    ...
    def forward(self, x):
        ...
        return {"0": out_2, "1": out_3, "2": out_4, "3": out_5}
